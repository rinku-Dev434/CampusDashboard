...
import { FaInfoCircle, FaEnvelope, FaBriefcase, FaNewspaper } from "react-icons/fa";

export default function Footer() {
  return (
    <footer className="footer footer-center bg-neutral text-neutral-content rounded p-10">

      {/* Horizontal links - centered */}
      ...
      {/* Copyright */}
      <aside>
        <p> {new Date().getFullYear()} - All right reserved by <span className="text-pink-400 font-semibold">Campus Dashboard</span></p>
      </aside>
